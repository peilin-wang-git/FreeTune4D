...
def complex_loss(image_warp, image_fixed, mask_moving, mask_fixed, contour_moving, contour_fixed):
    """
    This loss contains multiple components, including MSE within body mask, DICE
    score, and flow gradient.
    """
